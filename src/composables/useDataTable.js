...
export function useDataTable(defaultFilters = {}, only = ['urlParams']) {
    ...
    function parseUrlParams(urlParams) {
        ...
        sortOrder.value = parseInt(urlParams?.sortOrder) || dataTableDefaults.sortOrder;
        currentPage.value = parseInt(urlParams?.page) || dataTableDefaults.currentPage;
        rowsPerPage.value = parseInt(urlParams?.rows) || dataTableDefaults.rowsPerPage;
    }
